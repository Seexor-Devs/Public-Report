...
///////////////////////////////////////////////////////////////////////
 ...
 - ✔️ todo:   realizzazione pagine statiche
     ...
     - ✔️ home.php
        - ✔️ todo: call per prodotti    
        - ➗ todo: splitter (quantità per pagina)    
        - ➗ todo: splitter (più economico, più caro, votato, recente)    
        - ➗ todo: sidebar (articoli per..., prezzo, tipologia, brand)    
     ...
     - !!✔️ categorylist.php (DA MIGLIORARE)
        - ✔️ category.php
           - ➗ todo: call per prodotti per questa categoria   
           - ➗ todo: splitter (quantità per pagina)    
           - ➗ todo: splitter (più economico, più caro, votato, recente)    
           - ➗ todo: sidebar (articoli per..., prezzo, tipologia, brand)    
           - ➗ todo: box prodotti suggeriti    
           - ➗ todo: box categorie suggerite  
...
- ⭕ todo:   shop.tags.taglist.php è fatta ma: RESA STABILE MA MANCA IL SISTEMA PER GESTIRLI
...
///////////////////////////////////////////////////////////////////////
 ...
 - 🔸 fix/up:  Immagine profilo utenti: manca come reperire lo status di approvazione/rigetto
               (l'immagine non approvata non devo visualizzarla in frontoffice)

 - 🔸 fix:    collegamento ultime mail + manca la parte messaggi al delete,disable,contact su user, brand ecc.
 ...
 - 🔸 fix:    Ricerca frontoffice paginazione avanzata, filtri avanzati.

 - ➖ todo:    RICERCHE BACKOFFICE -> Nulla, complicate. 
               mio: continuerò prima a magheggiare bene io prima di scocciarvi.

 - ⭕ fix/up:  RICERCHE FRONTOFFICE
 ...
 - ⭕ todo:    Manca gestione tags (elimina questo tag, aggiorna questo tag). E' probabile che per come impostata la cosa non sia facile o possibile farlo

 - 🔸 CHROME: (frontoffice) File download appare vuoto

 - ⭕ todo:    ultimare Dashboard
 - 🔥 todo:    ultimare frontoffice (aggiornare pagina categorie)
